"""Audit helper for the family perception module."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Audit family module question list")
    parser.add_argument("--path", help="Path to JSON file with family items", default=None)
